...
contract Minter is Ownable {
    ...
    function depositByCollateralAddress(
        ...
        CollateralPositions storage collateralBalance = collateralBalances[_collateralAddress][msg.sender];
        totalCollateralAmount[_collateralAddress] = totalCollateralAmount[_collateralAddress].add(_collateralAmount);
        collateralBalance.totalTokensMinted = collateralBalance.totalTokensMinted.add(_numTokens);
        collateralBalance.totalCollateralAmount = collateralBalance.totalCollateralAmount.add(_collateralAmount);
        IERC20(_collateralAddress).transferFrom(msg.sender, address(this), _collateralAmount);
        IRewards(rewardsContract).depositMinter(_collateralAddress, msg.sender, _collateralAmount);
    ...
    function redeemByCollateralAddress(
        ...
        CollateralPositions storage collateralBalance = collateralBalances[_collateralAddress][msg.sender];
        totalCollateralAmount[_collateralAddress] = totalCollateralAmount[_collateralAddress].sub(_collateralAmount);
        IERC20(phmAddress).transferFrom(msg.sender, address(this), _tokenAmount);
        collateralBalance.totalTokensMinted = collateralBalance.totalTokensMinted.sub(_tokenAmount);
        collateralBalance.totalCollateralAmount = collateralBalance.totalCollateralAmount.sub(_collateralAmount);
        IRewards(rewardsContract).withdrawMinter(_collateralAddress, msg.sender, _collateralAmount);
    ...
    function getUserCollateralByCollateralAddress(
        ...
        return collateralBalances[_collateralAddress][_user].totalCollateralAmount;
    }
