...
const expectedPerSecondHALOReward = 50000;
...
//         const unclaimedMinterLPRewards = await rewardsContract.getUnclaimedMinterLPRewardsByUser(collateralERC20Contract.address, owner.address);
