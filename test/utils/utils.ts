...
export const parseCurrency = (tokenName: TOKEN_NAME, tokenDecimal: TOKEN_DECIMAL, amountInEther: string) => {
  let convertedValue;
...
export const formatCurrency = (tokenName: TOKEN_NAME, tokenDecimal: TOKEN_DECIMAL, amountInEther: BigNumberish) => {
  let convertedValue;
...
export const getLatestBlockTime = async (provider: Provider): Promise<number> => {
